...
| **Shape model**       | Named shapes (PostgreSQL.VM.Standard.E4.Flex.2.32GB)     | Instance classes (db.t4g.micro, db.r6g.large, etc.) |
...
- Shape: `PostgreSQL.VM.Standard.E4.Flex.2.32GB` (2 OCPUs, 32 GB RAM)
